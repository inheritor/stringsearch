...
def parse(search_term, search_tag, p):
    ...
    for search_row in search_rows:
        ...
        scraperwiki.sqlite.save(unique_keys=['Date'], data={'SearchString': unicode(search_term), 'Search Tag': unicode(search_tag), 'Title': unicode(title), 'ASIN': asin, 'PubDate': unicode(pubdate), 'Author': unicode(author), 'Format': unicode(item_format), 'PriceRent': unicode(price_rent), 'Price': unicode(price), 'PriceLow': unicode(low_price), 'OfferCount': unicode(offer_count), 'Other1Format': unicode(other1format), 'Other1ASIN': unicode(other1asin), 'Other2Format': unicode(other2format), 'Other2ASIN': other2asin, 'Other3Format': unicode(other3format), 'Other3ASIN': other3asin, 'Newer_Edition': unicode(newer), 'TradeIn': unicode(tradein), 'Date': today_date})
